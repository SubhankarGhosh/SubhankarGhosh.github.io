...
<div class="past-work">
  ...
  <ul class="event-list">
    <li><strong>Applied Scientist II Intern, Amazon Science (Summer 2025):</strong> Developed generative AI and multimodal fusion methods for anomaly detection in the <a href="https://www.amazon.science/" class="group-link">Amazon Science</a> Geospatial Team (Bellevue, WA). <span class="skill-badge">Generative AI</span><span class="skill-badge">Multimodal Fusion</span><span class="skill-badge">Anomaly Detection</span></li>
    ...
    <li><strong>Researcher:</strong> Spatial pattern mining with statistical guarantees. <span class="skill-badge">Pattern Mining</span><span class="skill-badge">Spatial Stats</span></li>
  </ul>
</div>
